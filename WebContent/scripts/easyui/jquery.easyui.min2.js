...
(function ($) {
    ...
    $.fn.pagination.parseOptions = function (_9f) {
        var t = $(_9f);
        return $.extend({}, $.parser.parseOptions(_9f, [
...
(function ($) {
    ...
    $.fn.window.parseOptions = function (_240) {
        return $.extend({}, $.fn.panel.parseOptions(_240), $.parser.parseOptions(_240, [
...
(function ($) {
    ...
    function _34a(_34b, _34c, _34d) {
        ...
        function _350(dir) {
            ...
            var _354 = $.extend({}, $.fn.layout.paneldefaults, {cls:"layout-expand", title:"&nbsp;", closed:true, doSize:false, tools:[
    ...
    $.fn.layout.parseOptions = function (_36b) {
        return $.extend({}, $.parser.parseOptions(_36b, [
            {fit:"boolean"}
        ]));
    };
...
(function ($) {
            ...
            if (menu.hasClass("menu-content")) {
                ...
                menu.children("div").each(function () {
                    ...
                    if (item.hasClass("menu-sep")) {
                        ...
                        item.attr("name", _375.name || "").attr("href", _375.href || "");
    ...
    function _390(_391, _392) {
        ...
        if (_392.href) {
            item.attr("href", _392.href);
        }
        if (_392.name) {
            item.attr("name", _392.name);
        }
        if (_392.onclick) {
    ...
    $.fn.menu.methods = {options:function (jq) {
        ...
        var t = $(_3a0);
        var item = {target:_3a0, id:t.attr("id"), text:$.trim(t.children("div.menu-text").html()), disabled:t.hasClass("menu-item-disabled"), href:t.attr("href"), name:t.attr("name"), onclick:_3a0.onclick};
...
(function ($) {
    ...
    function _4ef(_52e, _52f) {
        ...
        var _530 = (_52f == true) ? (opts.frozenColumns || [
            []
        ]) : opts.columns;
        if (_530.length == 0) {
            return [];
...
(function ($) {
    ...
    $.fn.propertygrid.parseOptions = function (_6be) {
        var t = $(_6be);
        return $.extend({}, $.fn.datagrid.parseOptions(_6be), $.parser.parseOptions(_6be, [
            {showGroup:"boolean"}
        ]));
    };
    ...
    ], showGroup:false, groupField:"group", groupFormatter:function (_6dd, rows) {
        return _6dd;
    }});
})(jQuery);
(function ($) {
