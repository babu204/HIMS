...
(function ($) {
    ...
    }, plugins:["easyuiDraggable", "easyuiDroppable", "resizable", "pagination", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree", "combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "numberspinner", "timespinner", "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid", "easyuiTabs", "easyuiAccordion", "window", "dialog"], parse:function (_2) {
        var aa = [];
...
(function ($) {
    ...
    ;
    $.fn.easyuiAccordion = function (_26e, _26f) {
        if (typeof _26e == "string") {
            return $.fn.easyuiAccordion.methods[_26e](this, _26f);
        }
        _26e = _26e || {};
        return this.each(function () {
            ...
            if (_270) {
                ...
                opts = $.extend({}, $.fn.easyuiAccordion.defaults, $.fn.easyuiAccordion.parseOptions(this), _26e);
                var r = _24c(this);
    ...
    $.fn.easyuiAccordion.methods = {options:function (jq) {
    ...
    $.fn.easyuiAccordion.parseOptions = function (_276) {
        var t = $(_276);
        return $.extend({}, $.parser.parseOptions(_276, ["width", "height", {fit:"boolean", border:"boolean", animate:"boolean"}]));
    };
    $.fn.easyuiAccordion.defaults = {width:"auto", height:"auto", fit:false, border:true, animate:true, onSelect:function (_277, _278) {
...
(function ($) {
    ...
    ;
    $.fn.easyuiTabs = function (_2cf, _2d0) {
        if (typeof _2cf == "string") {
            return $.fn.easyuiTabs.methods[_2cf](this, _2d0);
        }
        _2cf = _2cf || {};
        return this.each(function () {
            ...
            if (_2d1) {
                ...
                $.data(this, "tabs", {options:$.extend({}, $.fn.easyuiTabs.defaults, $.fn.easyuiTabs.parseOptions(this), _2cf), tabs:[], selectHis:[]});
                _29c(this);
            }
            _28c(this);
            _29f(this);
    ...
    $.fn.easyuiTabs.methods = {options:function (jq) {
        return $.data(jq[0], "tabs").options;
    }, easyuiTabs:function (jq) {
        return $.data(jq[0], "tabs").easyuiTabs;
    }, resize:function (jq) {
        return jq.each(function () {
            _290(this);
            _296(this);
        ...
        return jq.each(function () {
            $(this).easyuiTabs("getTab", _2d8).panel("options").tab.removeClass("tabs-disabled");
        });
    }, disableTab:function (jq, _2d9) {
        return jq.each(function () {
            $(this).easyuiTabs("getTab", _2d9).panel("options").tab.addClass("tabs-disabled");
        });
    }};
    $.fn.easyuiTabs.parseOptions = function (_2da) {
        return $.extend({}, $.parser.parseOptions(_2da, ["width", "height", "tools", {fit:"boolean", border:"boolean", plain:"boolean"}]));
    };
    $.fn.easyuiTabs.defaults = {width:"auto", height:"auto", plain:false, fit:false, border:true, tools:null, scrollIncrement:100, scrollDuration:400, onLoad:function (_2db) {
