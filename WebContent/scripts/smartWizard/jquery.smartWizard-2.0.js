...
(function($){
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                msgBox = $('.msgBox',obj);
                if(msgBox.length == 0){
                  msgBox = $('<div class="msgBox"><div class="content ui-corner-all"></div><a href="#" class="close">X</a></div>');
                ...
                function init(){
                  ...
                  allDivs.addClass("content ui-corner-all");
                  // Create Elements
                  loader = $('<div>Loading</div>').addClass("loader");
                  elmActionBar = $('<div></div>').addClass("actionBar");
                  elmStepContainer = $('<div></div>').addClass("stepContainer");
                  btNext = $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext btn btn-primary");
                  btPrevious = $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious btn btn-primary");
                  btFinish = $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("buttonFinish btn btn-danger");
                ...
                function showStep(stepIdx){
                    ...
                    elmStepContainer.height(700);
                    $($(selStep, obj).attr("href"), obj).height(680);
