...
function removeComma(inputValue) {
	...
	re = /,/gi;
	return strInputValue.replace(re, "");
}

/**
 * Copy from jquery validate 'dateITA' rule
 * 
 * @param datetext
 * @return
 */
...
function formatJsonDate(json){
	var dt = Date.parseDate(json, 'Y/m/d H:i:s'); 
	return dt.format("d/m/Y");
}

function formatJsonDatetime(json){
	var dt = Date.parseDate(json, 'Y/m/d H:i:s'); 
